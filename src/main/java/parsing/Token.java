...
public class Token {
    ...
    public enum Type {
        IDENTIFIER, STRING, COMMA, PERIOD, INT, INTLITERAL, DECIMAL, DECIMALLITERAL, BOOLEAN, BOOLEANLITERAL, SEMICOLON, COLON,
        OPEN, CLOSED, STAR, EQUAL, USE, CREATE, DROP, DATABASE, TABLE, PRIMARY, FOREIGN, KEY, REFERENCES, NOT, NULL,
        SELECT, FROM, WHERE,LESS,GREATER, INSERT, INTO, VALUES, ALTER, UPDATE, ADD, DELETE, VARCHAR, TEXT, TRUNCATE, START,
        TRANSACTION, COMMIT
    }
